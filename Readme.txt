...
your network is set up correctly, you could 
use it across a WAN or Internet connection.
As far as I know, it should work with IPv6
addresses, which gives you a little more
flexibility, but nobody wants to type
